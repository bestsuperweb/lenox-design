...
<body>
  ...
  <section id="home-banner">
    <video src="assets/video/lenoxapts.mp4" autoplay loop>      
    </video>
    <div class="home-tagline text-center">
      <div class="tagline-item">
        <h1 class="wow zoomIn">
          “Harlem’s <span>Best</span> Address”        
        </h1>
        <p class="wow fadeInUp">The New York Times</p>
      </div>      
      <div class="tagline-item">
        <h1 class="wow zoomIn">
          <span>More</span> Than Just Living  
        </h1>
      </div>
      <div class="tagline-item">
      <h1 class="wow bounceInDown">
          Harlem’s <span>Finest</span> No Fee<br>Rental Apartments      
        </h1>
      </div>      
      <div class="scroll">
